...
class EcranLocalisationGridview extends StatefulWidget {
  ...
  const EcranLocalisationGridview({Key? key, required this.selectedLocalisation})
      : super(key: key);
  ...
  Future<void> _chargerDonnees() async {
    try {
      ...
      setState(() {
        ...
        // Filtrer les livres correspondant au Localisation sélectionné
        filteredLivres = jsonData
            .where((livreData) => livreData['localisation'] == widget.selectedLocalisation)
            .toList();
      });
    } catch (e) {
